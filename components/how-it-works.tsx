...
//     description: "Analyze engagement, identify problem areas, and improve freemium conversion every day during the trial period.",
//     steps: [
...
//     description: "Record, replay, and analyze user sessions with data-rich insights into user behavior to address real-time issues.",
//     steps: [
...
//           How Milir Turns Trial Users<br />to Paid Customers
//         </h2>
//         <div ref={sectionRef} className="space-y-32">
//           {steps.map((step, index) => (
//             <div key={index} className={`step-section flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center justify-between opacity-0 translate-y-10 transition-all duration-1000 ease-in-out`}>
