...
export default function Hero() {
  return (
    <section className="w-full min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      {/* Content Overlay */}
      <div className="relative z-10 container mx-auto px-4 py-16 flex flex-col lg:flex-row items-center">
        <motion.div 
          className="lg:w-1/2 mb-12 lg:mb-0 text-center lg:text-left"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        >
          <h1 className="text-3xl md:text-3xl lg:text-6xl font-medium text-white mb-6 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <Button className="bg-[#ffffff] text-red-500 hover:bg-[#faf8f8] text-lg px-8 py-4 rounded-md shadow-md transition-all duration-300">
              Start Free Trial
            </Button>
          </div>
        </motion.div>
        ...
        >
          <div className="relative">
            {/* Decorative Blurs */}
            <div className="absolute -top-4 -left-4 w-24 h-24 bg-[#FF4958] rounded-full opacity-20 blur-2xl" />
            <div className="absolute -bottom-2 -right-4 w-32 h-32 bg-[#FF4958] rounded-full opacity-20 blur-2xl" />
          </div>
        </motion.div>
      </div>
    </section>
